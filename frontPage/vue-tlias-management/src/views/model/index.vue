  ...
  <el-container class="page-container">
    <el-header class="header-bar">
      ...
      <div class="header-right">
        ...
        <el-button type="primary" size="small" :disabled="collecting" @click="startAnalysis">启动模型</el-button>
    ...
    <el-main class="main">
      <el-row :gutter="20">
        <el-col :span="14"><el-card class="chart-card"><div class="card-title">模型指数趋势</div><div ref="trendRef" class="chart"></div></el-card></el-col>
        <el-col :span="10"><el-card class="chart-card"><div class="card-title">当前推理指数</div><div ref="barRef" class="chart"></div></el-card></el-col>
      </el-row>
